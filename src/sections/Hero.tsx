...
export const HeroSection = () => {
  return (
    <div id = "home" className="py-32 md:py-48 lg:py-55 relative z-0 overflow-x-clip">
  <div
...
>
      ...
      <HeroOrbit size={800} rotation={-72} shouldOrbit orbitDuration="42s" shouldSpin spinDuration="6s">
      ...
      <div className="container">
        <div className="flex flex-col items-center">
          ...
          <div className="bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg">
            ...
            <div className="text-sm font-medium">Ready To Be Hired!</div>
          </div>
        </div>
        <div className="max-w-lg mx-auto">
        <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">Weaving Magic into User Interactions</h1>
